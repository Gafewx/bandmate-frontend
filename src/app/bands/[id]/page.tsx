...
import TimeFinder from '@/src/components/TimeFinder';
...
export default function BandDetailPage() {
    ...
    const [activeTab, setActiveTab] = useState<'dashboard' | 'chat' | 'setlist' | 'schedule'>('dashboard');
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white font-sans pb-20">
            ...
            <div className="print:hidden">
                ...
                <div className="flex justify-center mt-6 gap-2">
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-full font-bold text-sm transition-all flex items-center gap-2 ${activeTab === 'schedule' ? 'bg-yellow-500 text-black shadow-lg scale-105' : 'bg-zinc-900 text-zinc-500 hover:text-white'}`}
                    >
                        📅 Schedule
                    </button>
            ...
            <div className="max-w-6xl mx-auto px-6 mt-8">
                ...
                {activeTab === 'schedule' && (
                    <div className="animate-in fade-in zoom-in duration-300">
                        <TimeFinder bandId={Number(id)} userId={user?.user_id} />
                    </div>
                )}
